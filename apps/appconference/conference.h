...
typedef struct tris_conference_stats
{
...
struct tris_conference
{
	...
	struct tris_conf_member* memberlist ;
	int membercount ;
        int id_count;
	...
	struct tris_conference* next ;

	// pointer to translation paths
	struct tris_trans_pvt* from_slinear_paths[ AC_SUPPORTED_FORMATS ] ;
...
int queue_frame_for_listener( struct tris_conference* conf, struct tris_conf_member* member, conf_frame* frame ) ;
int queue_frame_for_speaker( struct tris_conference* conf, struct tris_conf_member* member, conf_frame* frame ) ;
int queue_silent_frame( struct tris_conference* conf, struct tris_conf_member* member ) ;
