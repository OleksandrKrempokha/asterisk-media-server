...
struct tris_conf_member
{
	...
	char* receiver_channel_name; // channel name of the member who receive video from this member
	...
	// is this person a admin?
	int is_admin;

	// has this persion dialouted?
	int is_dialouted;
	...
	conf_frame* inDesktopFrames ;
	conf_frame* inDesktopFramesTail ;
	unsigned int inDesktopFramesCount ;
	...
	conf_frame* outDesktopFrames ;
	conf_frame* outDesktopFramesTail ;
	unsigned int outDesktopFramesCount ;
	...
	unsigned long desktop_frames_in ;
	unsigned long desktop_frames_in_dropped ;
	unsigned long desktop_frames_out ;
	unsigned long desktop_frames_out_dropped ;
...
int notify_members(struct tris_conference * conf, struct tris_conf_member * member, int flag);
