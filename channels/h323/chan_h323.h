...
/* structure to hold the valid trismedia users */
struct oh323_user {
...
/* structure to hold the valid trismedia peers
...
/** call_details struct call detail records
	to trismedia for processing and used for matching up
	trismedia channels to acutal h.323 connections */
...
/* This is a callback prototype function, called to collect
   the external RTP port from Trismedia. */
...
/* This is a callback prototype function, called to send
   the remote IP and RTP port from H.323 to Trismedia */
...
typedef void (*setpeercapabilities_cb)(unsigned, const char *, int, struct tris_codec_pref *);
...
extern "C" {
	...
	void h323_callback_register(setup_incoming_cb,
					...
					onhold_cb);
	int h323_set_capabilities(const char *, int, int, struct tris_codec_pref *, int);
