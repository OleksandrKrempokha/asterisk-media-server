...
static int slin16_to_slin8_new(struct tris_trans_pvt *pvt)
{
...
static int slin8_to_slin16_new(struct tris_trans_pvt *pvt)
{
...
static void slin16_to_slin8_destroy(struct tris_trans_pvt *pvt)
{
	struct slin16_to_slin8_pvt *resamp_pvt = pvt->pvt;
...
static void slin8_to_slin16_destroy(struct tris_trans_pvt *pvt)
{
	struct slin8_to_slin16_pvt *resamp_pvt = pvt->pvt;
...
static int resample_frame(struct tris_trans_pvt *pvt,
	void *resampler, float resample_factor, struct tris_frame *f)
{
...
static int slin16_to_slin8_framein(struct tris_trans_pvt *pvt, struct tris_frame *f)
{
	struct slin16_to_slin8_pvt *resamp_pvt = pvt->pvt;
...
static int slin8_to_slin16_framein(struct tris_trans_pvt *pvt, struct tris_frame *f)
{
	struct slin8_to_slin16_pvt *resamp_pvt = pvt->pvt;
	void *resampler = resamp_pvt->resampler;
	float resample_factor = resamp_pvt->resample_factor;
...
static struct tris_translator slin16_to_slin8 = {
...
static struct tris_translator slin8_to_slin16 = {
...
static int unload_module(void)
{
	...
	res |= tris_unregister_translator(&slin16_to_slin8);
	res |= tris_unregister_translator(&slin8_to_slin16);
...
static int load_module(void)
{
	...
	res |= tris_register_translator(&slin16_to_slin8);
	res |= tris_register_translator(&slin8_to_slin16);

	return TRIS_MODULE_LOAD_SUCCESS;
}

TRIS_MODULE_INFO_STANDARD(TRISMEDIA_GPL_KEY, "SLIN Resampling Codec");
