...
static void Ftris_Short_term_analysis_filtering P4((u,rp,k_n,s),
	register word * u;
...
static void Ftris_Short_term_synthesis_filtering P5((S,rrp,k,wt,sr),
	struct gsm_state * S,
	register word	* rrp,	/* [0..7]	IN	*/
	register int	k,	/* k_end - k_start	*/
	register word	* wt,	/* [0..k-1]	IN	*/
...
# 	define	FILTER 	(* (S->fast			\
			   ? Ftris_Short_term_analysis_filtering	\
...
# 	define	FILTER 	(* (S->fast			\
			   ? Ftris_Short_term_synthesis_filtering	\
