...
CREATE TABLE `iaxfriends` (
  ...
  `ipaddr` varchar(20) NULL, -- Must be updateable by Trismedia user
  `port` int(5) NULL, -- Must be updateable by Trismedia user
  `defaultip` varchar(20) NULL,
  `sourceaddress` varchar(20) NULL,
  `mask` varchar(20) NULL,
  `regexten` varchar(40) NULL,
  `regseconds` int(11) NULL, -- Must be updateable by Trismedia user
