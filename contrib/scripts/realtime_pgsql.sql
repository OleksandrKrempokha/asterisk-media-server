...
ALTER TABLE queue_table OWNER TO trismedia;
...
GRANT ALL ON TABLE cdr TO trismedia;
GRANT ALL ON TABLE extensions_conf TO trismedia;
GRANT ALL ON TABLE sip_conf TO trismedia;
GRANT ALL ON TABLE voicemail_users TO trismedia;
GRANT ALL ON TABLE queue_member_table TO trismedia;
GRANT ALL ON TABLE queue_table TO trismedia;
