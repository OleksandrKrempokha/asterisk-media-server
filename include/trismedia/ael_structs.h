...
/*! \file
 * \brief Structures for AEL - the Trismedia extension language
 *
 * \ref pbx_ael.c
 * \todo document this file (ael.h)
 */

#ifndef _TRISMEDIA_AEL_STRUCTS_H
#define _TRISMEDIA_AEL_STRUCTS_H

/*
 * We include trismedia/paths.h here because it is a convenient place
...
#endif /* _TRISMEDIA_AEL_STRUCTS_H */
