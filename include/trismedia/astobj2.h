...
#ifndef _TRISMEDIA_ASTOBJ2_H
#define _TRISMEDIA_ASTOBJ2_H
...
multiple times on the same object, commonly fatal to trismedia.
...
before the #include "trismedia/astobj2.h" line, and add a descriptive
tag to each call. Recompile, and run Trismedia, exit trismedia with
