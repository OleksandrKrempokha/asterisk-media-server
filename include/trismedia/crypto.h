...
#ifndef _TRISMEDIA_CRYPTO_H
#define _TRISMEDIA_CRYPTO_H

#if defined(__cplusplus) || defined(c_plusplus)
extern "C" {
#endif

#define TRIS_KEY_PUBLIC	(1 << 0)
#define TRIS_KEY_PRIVATE	(1 << 1)
 ...
 * \param int type of key (TRIS_KEY_PUBLIC or TRIS_KEY_PRIVATE)
 *
 * \retval the key on success.
 * \retval NULL on failure.
 */
extern struct tris_key *(*tris_key_get)(const char *key, int type);
 ...
 *
 */
extern int (*tris_check_signature)(struct tris_key *key, const char *msg, const char *sig);
 ...
 *
 */
extern int (*tris_check_signature_bin)(struct tris_key *key, const char *msg, int msglen, const unsigned char *sig);
 ...
 *
 */
extern int (*tris_sign)(struct tris_key *key, char *msg, char *sig);
 ...
 *
 */
extern int (*tris_sign_bin)(struct tris_key *key, const char *msg, int msglen, unsigned char *sig);
 ...
 *
 */
extern int (*tris_encrypt_bin)(unsigned char *dst, const unsigned char *src, int srclen, struct tris_key *key);
 ...
 *
 */
extern int (*tris_decrypt_bin)(unsigned char *dst, const unsigned char *src, int srclen, struct tris_key *key);
#if defined(__cplusplus) || defined(c_plusplus)
}
#endif

#endif /* _TRISMEDIA_CRYPTO_H */
