...
#ifndef _TRISMEDIA_DNS_H
#define _TRISMEDIA_DNS_H
...
/*!	\brief	Perform DNS lookup (used by DNS, enum and SRV lookups)
	...
	\note   Trismedia DNS is synchronus at this time. This means that if your DNS
		services does not work, Trismedia may lock while waiting for response.
*/
int tris_search_dns(void *context, const char *dname, int class, int type,
	 int (*callback)(void *context, unsigned char *answer, int len, unsigned char *fullanswer));

#endif /* _TRISMEDIA_DNS_H */
