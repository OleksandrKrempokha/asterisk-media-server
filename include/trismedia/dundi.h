...
#ifndef _TRISMEDIA_DUNDI_H 
#define _TRISMEDIA_DUNDI_H
...
typedef struct tris_eid dundi_eid;
...
*/
int dundi_lookup(struct dundi_result *result, int maxret, struct tris_channel *chan, const char *dcontext, const char *number, int nocache);
