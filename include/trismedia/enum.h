...
#ifndef _TRISMEDIA_ENUM_H
#define _TRISMEDIA_ENUM_H
...
/*! \brief Lookup entry in ENUM
	...
	\retval -1 on hangup
*/
int tris_get_enum(struct tris_channel *chan, const char *number, char *location, int maxloc, char *technology,
 ...
 */
int tris_get_txt(struct tris_channel *chan, const char *number, char *txt, int maxtxt, char *suffix);

int tris_enum_init(void);
int tris_enum_reload(void);

#endif /* _TRISMEDIA_ENUM_H */
