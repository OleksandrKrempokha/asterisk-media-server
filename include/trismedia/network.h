...
#ifndef _TRISMEDIA_NETWORK_H
#define _TRISMEDIA_NETWORK_H
...
#undef inet_ntoa
#endif
#define inet_ntoa __dont__use__inet_ntoa__use__tris_inet_ntoa__instead__
