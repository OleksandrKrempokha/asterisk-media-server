...
#ifndef _TRISMEDIA_TERM_H
#define _TRISMEDIA_TERM_H
 ...
 *         plus a null char */
#define TRIS_TERM_MAX_ESCAPE_CHARS   23

char *term_color(char *outbuf, const char *inbuf, int fgcolor, int bgcolor, int maxout);

/*!
 * \brief Append a color sequence to an tris_str
 *
