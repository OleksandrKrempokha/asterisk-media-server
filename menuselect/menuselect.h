...
struct member {
	...
	TRIS_LIST_HEAD_NOLOCK(, depend) deps;
	/*! conflicts of this module */
	TRIS_LIST_HEAD_NOLOCK(, conflict) conflicts;
	/*! optional packages used by this module */
	TRIS_LIST_HEAD_NOLOCK(, use) uses;
	/*! for making a list of modules */
	TRIS_LIST_ENTRY(member) list;
};
...
struct category {
	...
	TRIS_LIST_HEAD_NOLOCK(, member) members;
	/*! for linking */
	TRIS_LIST_ENTRY(category) list;
};

extern TRIS_LIST_HEAD_NOLOCK(categories, category) categories;
