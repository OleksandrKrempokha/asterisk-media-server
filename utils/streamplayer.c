 ...
 * used as a music on hold source for Trismedia.  Some devices are capable of
 ...
 * stream and dumps it straight to stdout.  Due to the way Trismedia handles
 ...
 * serviced, even if Trismedia is not currently using the source.
 *
...
int main(int argc, char *argv[])
{
	...
	if (argc != 3) {
		...
		fprintf(stderr, "Written for use with Trismedia (http://www.trismedia.org)\n");
